...
public class RegistrationTest extends App {
	...
	public void testInlineErrorFields() {
		...
		Assert.assertEquals(registrationPage.getFirstNameErrorMsg(),
				utils.readTestData("copy", "registrationPage", "fieldErrorMsg"));
		common.dismissKeyboardShown();
		registrationPage.tapPostcodeField();
		Assert.assertEquals(registrationPage.getSurnameErrorMsg(),
				utils.readTestData("copy", "registrationPage", "fieldErrorMsg"));
		registrationPage.tapFirstNameField();
		common.dismissKeyboardShown();
		Assert.assertEquals(registrationPage.getPostcodeErrorMsg(),
				utils.readTestData("copy", "registrationPage", "fieldErrorMsg"));
	}
	...
	public void testValidationOnSubmit() {
		...
		Assert.assertEquals(registrationPage.getSurnameErrorMsg(),
				utils.readTestData("copy", "registrationPage", "fieldErrorMsg"));
		Assert.assertEquals(registrationPage.getDOBErrorMsg(),
				utils.readTestData("copy", "registrationPage", "fieldErrorMsg"));
		Assert.assertEquals(registrationPage.getPostcodeErrorMsg(),
				utils.readTestData("copy", "registrationPage", "fieldErrorMsg"));
	...
	public void testValidationOnSubmitEmailScreen() {
		...
		registrationPage.tapNextButton();
		Assert.assertEquals(registrationPage.getInvalidEmailErrorMsg(),
				utils.readTestData("copy", "registrationPage", "invalidEmailErrorMsg"));
		Assert.assertEquals(registrationPage.getInvalidMobileErrorMsg(),
				utils.readTestData("copy", "registrationPage", "invalidMobileErrorMsg"));

	}

	/*
	 * @Test(groups = {"DMPM-184", "DMPM-435", "marketplace", "Registration",
	 * "priority-major"}) public void inlineErrorValidationOnTapout() {
	 * navigateToRegistrationPage(); registrationPage.tapNextButton();
	 * Assert.assertEquals(registrationPage.getFirstNameErrorMsg(),
	 * utils.readTestData("copy", "registrationPage", "fieldErrorMsg"));
	 * Assert.assertEquals(registrationPage.getSurnameErrorMsg(),
	 * utils.readTestData("copy", "registrationPage", "fieldErrorMsg"));
	 ...
	 * Assert.assertEquals(registrationPage.getPostcodeErrorMsg(),
	 * utils.readTestData("copy", "registrationPage", "fieldErrorMsg"));
	 * registrationPage.tapFirstNameField(); registrationPage.tapSurnameField();
	 * registrationPage.enterSurname(utils.readTestData("registration", "failure",
	 * "1letterSurname"));
	 * Assert.assertEquals(registrationPage.getSurnameErrorMsg(),
	 * utils.readTestData("copy", "registrationPage", "shortSurnameErrorMsg"));
	 * registrationPage.enterSurname(utils.readTestData("registration", "failure",
	 * "longSurname")); Assert.assertEquals(registrationPage.getSurnameErrorMsg(),
	 * utils.readTestData("copy", "registrationPage", "shortSurnameErrorMsg"));
	 * registrationPage.enterSurname(utils.readTestData("registration", "failure",
	 * "40charSurname"));
	 * Assert.assertNull(registrationPage.checkSurnameErrorMsg()); //TODO: Date
	 * picker not automated
	 * 
	 * }
	 */
	...
	public void testInlineErrorValidations() {
		...
		Assert.assertEquals(registrationPage.getFirstNameInvalidErrorMsg(),
				utils.readTestData("copy", "registrationPage", "specialCharErrorMsg"));
		registrationPage.tapSurnameField();
		registrationPage.tapFirstNameField();
		Assert.assertEquals(registrationPage.getSurnameInvalidErrorMsg(),
				utils.readTestData("copy", "registrationPage", "fieldErrorMsg"));
	...
	public void testDisplayUserTips() {
		navigateToRegistrationPage();
		registrationPage.tapFirstNameField();
		Assert.assertEquals(registrationPage.getFirstNameUserTip(),
				utils.readTestData("copy", "registrationPage", "firstNameUserTip"));
		registrationPage.tapSurnameField();
		...
		Assert.assertEquals(registrationPage.getMobileNumberUserTip(),
				utils.readTestData("copy", "registrationPage", "mobileNumberUserTip"));
	...
	/*
	 * @Test(groups = {"DMPM-188", "DMPM-423", "marketplace", "Registration",
	 * "priority-minor"}) public void inlineMessageBehaviour() {
	 * navigateToRegistrationPage();
	 * registrationPage.fill1stPageFields(utils.readTestData("registration",
	 * "success", "firstName"), utils.readTestData("registration", "success",
	 * "surname"), utils.readTestData("registration", "success", "date"),
	 * utils.readTestData("registration", "success", "postcode"));
	 * registrationPage.tapNextButton();
	 * registrationPage.enterEmail(utils.readTestData("registration", "failure",
	 * "emailLong")); registrationPage.tapMobileNumberField();
	 * Assert.assertEquals(registrationPage.getInvalidEmailErrorMsg(),
	 * utils.readTestData("copy", "registrationPage", "invalidEmailErrorMsg"));
	 * registrationPage.tapEmailField();
	 * Assert.assertEquals(registrationPage.getInvalidEmailErrorMsg(),
	...
	public void testPasswordSetupScreen() {
		...
		registrationPage.fill1stPageFields(utils.readTestData("registration", "success", "firstName"),
				...
				utils.readTestData("registration", "success", "postcode"));
		registrationPage.tapNextButton();
		String mailAndPassword[] = registrationPage.fill2ndPageFields(
		...
		Assert.assertNotNull(registrationPage.checkPasswordCharRequirements(),
				"Password char requirement not as expected");
		Assert.assertNotNull(registrationPage.checkPasswordNameRequirements(),
				"Password name requirement not as expected");
	...
	public void testPasswordScreenInlineErrors() {
		...
		Assert.assertEquals(registrationPage.getPasswordErrorMsg(),
				utils.readTestData("copy", "registrationPage", "fieldErrorMsg"));
		registrationPage.tapPasswordField();
		Assert.assertEquals(registrationPage.getConfirmPasswordErrorMsg(),
				utils.readTestData("copy", "registrationPage", "fieldErrorMsg"));
	...
	public void testPasswordFieldValidation() {
		...
		registrationPage.tapConfirmPasswordField();
		Assert.assertTrue(
				registrationPage.checkPasswordRequirements(
						utils.readTestData("copy", "registrationPage", "shortPasswordErrorMsg")),
		...
		List<Object> firstNameInPasswordList = (List<Object>) utils.readTestDataList("registration", "failure",
				"firstNameInPassword");
		for (Object firstNameInPassword : (List<Object>) firstNameInPasswordList) {
			...
			Assert.assertTrue(
					registrationPage.checkPasswordRequirements(
							utils.readTestData("copy", "registrationPage", "firstNamePasswordErrorMsg")),
					"Error msg not displayed");
		}
		...
		List<Object> lastNameInPasswordList = (List<Object>) utils.readTestDataList("registration", "failure",
				"lastNameInPassword");
		for (Object lastNameInPassword : (List<Object>) lastNameInPasswordList) {
			...
			Assert.assertTrue(
					registrationPage.checkPasswordRequirements(
							utils.readTestData("copy", "registrationPage", "lastNamePasswordErrorMsg")),
					"Error msg not displayed");
		}
		...
		Assert.assertTrue(
				registrationPage.checkPasswordRequirements(
						utils.readTestData("copy", "registrationPage", "onlycharPasswordErrorMsg")),
				"Error msg not displayed");
		...
		Assert.assertTrue(
				registrationPage.checkPasswordRequirements(
						utils.readTestData("copy", "registrationPage", "onlyCharUpperCasePasswordErrorMsg")),
				"Error msg not displayed");
		...
		registrationPage.tapRegisterButton();
		Assert.assertEquals(registrationPage.getConfirmPasswordErrorMsg(),
				utils.readTestData("copy", "registrationPage", "passwordNotMatch"));
		registrationPage.tapConfirmPasswordField();
		Assert.assertEquals(registrationPage.getConfirmPasswordErrorMsg(),
				utils.readTestData("copy", "registrationPage", "passwordNotMatch"));
	...
	// DMPN-2730 : I don't have any credentials
	...
	public void testNoCredentialsSupportedBrand() {
		...
		Assert.assertNotNull(
				getStartedPage.checkRegisterWithSupportedGroupButton(supportedGroupName),
				"Get registered with supported group button is not displayed");
		
		// check the registration screen for supported group
		getStartedPage
				.tapRegisterWithSupportedGroupButton(supportedGroupName);
		Assert.assertEquals(loginPage.getLoginPageTitle().toLowerCase(),
				supportedGroupName
						+ utils.readTestData("copy", "registration", "supportedGroupLoginTitleSuffix"),
						supportedGroupName+ "Supported group login page title is not shown as expected");
		
		Assert.assertNotNull(loginPage.checkNoCredentialsButton(),
				"I don't have any credentials button is not displayed");
	...
	// DMPN-213 : Check if post code is valid
	@Test(groups = { "marketplace","Registration", "priority-major" })
	public void testPostcodeInlineError() {
		...
		Assert.assertNotNull(registrationPage.checkPostcodeInvalidErrorMsg(),
				"Postcode tooltip inline message is not displayed.");
		Assert.assertEquals(registrationPage.getPostcodeErrorMsg(),
				utils.readTestData("copy", "registrationPage", "fieldErrorMsg"),
		...
		Assert.assertNotNull(registrationPage.checkPostcodeInvalidErrorMsg(),
				"Postcode tooltip inline message is not displayed.");
		Assert.assertEquals(registrationPage.getPostcodeErrorMsg(),
				utils.readTestData("copy", "registration", "invalidPostcodeMessage"),
				"Incorrect postcode inline message is displayed");

		registrationPage.enterPostcode(utils.readTestData("registration", "success", "postcode"));
		registrationPage.tapNextButton();
		Assert.assertNull(registrationPage.checkPostcodeInvalidErrorMsg(),
				"Postcode tooltip inline message is displayed.");

	}

	// DMPN-329 : Updates to Validation of Maximum Length of Fields
	@Test(groups = {"marketplace", "Registration", "priority-major" })
	public void testMaximumLengthError() {
		...
		Assert.assertEquals(registrationPage.getFirstNameErrorMsg(),
				utils.readTestData("copy", "registrationPage", "longFirstNameErrorMsg"),
		...
		Assert.assertEquals(registrationPage.getSurnameErrorMsg(),
				utils.readTestData("copy", "registrationPage", "longSurnameErrorMsg"),
		...
		Assert.assertEquals(registrationPage.getInvalidMobileErrorMsg(),
				utils.readTestData("copy", "registrationPage", "longMobileErrorMsg"),
		...
		Assert.assertEquals(registrationPage.getInvalidEmailErrorMsg(),
				utils.readTestData("copy", "registrationPage", "longEmailErrorMsg"),
	...
	// DMPN-1058 : Prevent user name from being used when creating a password
	@Test(groups = { "marketplace","Registration", "priority-major" })
	public void testDesiredPasswordError() {
		...
		Assert.assertNotNull(registrationPage.checkPasswordNameRequirements(),
				"Password name requirements are not displayed.");
		Assert.assertEquals(registrationPage.getPasswordNameRequirementsText(),
				utils.readTestData("copy", "registrationPage", "passwordNameRequirement"),
		...
		Assert.assertNotNull(
				registrationPage.checkPasswordRequirements(
						utils.readTestData("copy", "registrationPage", "emailPasswordErrorMsg")),
