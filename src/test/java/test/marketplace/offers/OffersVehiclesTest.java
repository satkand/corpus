...
public class OffersVehiclesTest extends App {
	...
	@TestDetails(story1="DMPM-814:DMPM-926,DMPM-935", story2="DMPM-2253:DMPM-4649,DMPM-4650")
	@Test(groups = {"marketplace", "Offers", "priority-minor" })
	public void testVehicleJourneyOffers() {
		navigateToVehicleScreen("offers");
		...
		Assert.assertEquals(offersPage.getOffersDescriptionText(),
				utils.readTestData("offersPage", "vehiclesTab", "offerDescription"),
				"offer description for vehicles tab is not shown as expected");
		Assert.assertEquals(offersPage.getOffersPageTitle(),
				utils.readTestData("offersPage", "vehiclesTab", "offerTitle"),
	...
	// scenario 2
	@TestDetails(story1="DMPM-814:DMPM-927")
	@Test(groups = {"marketplace", "Offers", "priority-minor" })
	...
	private void navigateToVehicleScreen(String loginType) {
