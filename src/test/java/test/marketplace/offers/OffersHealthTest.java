...
public class OffersHealthTest extends App {
	...
	@TestDetails(story1 = "DMPM-817:DMPM-932", story2 = "DMPM-2253: DMPM-4649,DMPM-4650")
	@Test(groups = {"marketplace", "Offers", "priority-minor" })
	public void testHealthJourneyOffers() {
		navigateToHealthScreen("offers");
		...
		Assert.assertEquals(offersPage.getOffersDescriptionText(),
				utils.readTestData("offersPage", "healthTab", "offerDescription"),
				"offer description for health tab is not shown as expected");
		Assert.assertEquals(offersPage.getOffersPageTitle(),
				utils.readTestData("offersPage", "healthTab", "offerTitle"),
	...
	// scenario 2
	@TestDetails(story1 = "DMPM-817:DMPM-933")
	@Test(groups = {"marketplace", "Offers", "priority-minor" })
	...
	private void navigateToHealthScreen(String loginType) {
